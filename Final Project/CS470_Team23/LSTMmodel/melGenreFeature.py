...
class melGenreFeature:
    ...
    train_X_preprocessed_data = relative_path + "mel_data_train_input.npy"
    train_Y_preprocessed_data = relative_path + "mel_data_train_target.npy"
    valid_X_preprocessed_data = relative_path + "mel_data_valid_input.npy"
    valid_Y_preprocessed_data = relative_path + "mel_data_valid_target.npy"
    test_X_preprocessed_data = relative_path + "mel_data_test_input.npy"
    test_Y_preprocessed_data = relative_path + "mel_data_test_target.npy"
